...
# Import scripts
import load_data
import check_igfs_opt_AUC_crohn, check_igfs_opt_utils_AUC_crohn
...
def main_pipeline(args):
    ...
    X_train = check_igfs_opt_utils_AUC_crohn.data_scaler(X_train)
    ...
    mlflow.set_tracking_uri("http://158.42.170.77:5001")
    mlflow_exp_name = 'DB:' + str.upper(args.db) + '_OPTIMAL_NN_AUC_low_lr'
    ...
    for seed in seeds:
        ...
        ig_fs = check_igfs_opt_AUC_crohn.IGFS(X_train, y_train_dummy, t_cv_idx, v_cv_idx, args, classes)
