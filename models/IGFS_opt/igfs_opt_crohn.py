...
class IGFS:
    ...
    def fit(self, s_number, params):
        ...
        for i in range(self.t_cv_idx.shape[1]):
            ...
            igfs_opt_utils_crohn.set_seed(s_number)
            ...
            X_train_t, y_train_t, X_val_t, y_val_t = igfs_opt_utils_crohn.torch_tensors(X_train,
                                                                               y_train,
                                                                               X_val,
                                                                               y_val)
            # Load parameters and hyperparameters.
            criterion_rec, criterion_clf, layers, afunc = igfs_opt_utils_crohn.param_hparam_nn(params, self.args, self.X, self.y)
            epochs = 2500
            # Define NN model, optimizer and scheduler
            model = igfs_opt_utils_crohn.autoencoder_E2E(layers, afunc, params)
            ...
            X_train_t, y_train_t, X_val_t, y_val_t, criterion_rec, criterion_clf, model = igfs_opt_utils_crohn.transfer_device(X_train_t,
                                                                              y_train_t,
                                                                              X_val_t,
                                                                              y_val_t,
                                                                              criterion_rec,
            ...
            best_v_loss = igfs_opt_utils_crohn.train_eval_loop(epochs,
                                                      X_train_t,
                                                      y_train_t,
                                                      X_val_t,
                                                      y_val_t,
