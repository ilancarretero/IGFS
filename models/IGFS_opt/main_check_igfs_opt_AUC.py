...
# Import scripts
import load_data
import check_igfs_opt_AUC, check_igfs_opt_utils_AUC
...
def main_pipeline(args):
    ...
    X_train = check_igfs_opt_utils_AUC.data_scaler(X_train)
    ...
    for seed in seeds:
        ...
        ig_fs = check_igfs_opt_AUC.IGFS(X_train, y_train_dummy, t_cv_idx, v_cv_idx, args, classes)
