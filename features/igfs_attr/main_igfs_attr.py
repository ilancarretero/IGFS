...
# Import scripts
import load_data
import igfs_attr, igfs_attr_utils
...
def main_pipeline(args):
    ...
    X_train = igfs_attr_utils.data_scaler(X_train)
    ...
    for seed in seeds:
        ...
        ig_fs = igfs_attr.IGFS(X_train, y_train_dummy, t_cv_idx, v_cv_idx, args)
        df_attr_acc_class_0, df_attr_acc_class_1, df_attr_full_class_0, df_attr_full_class_1 = ig_fs.fit(seed)
        # Save data
        igfs_attr.save_data(df_attr_acc_class_0, seed, args, full=False, cl=0)
        igfs_attr.save_data(df_attr_acc_class_1, seed, args, full=False, cl=1)
        igfs_attr.save_data(df_attr_full_class_0, seed, args, full=True, cl=0)
        igfs_attr.save_data(df_attr_full_class_1, seed, args, full=True, cl=1)
