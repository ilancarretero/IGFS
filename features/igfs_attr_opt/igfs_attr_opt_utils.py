...
def train_eval_loop(epochs, train_tensor, y_train_tensor, val_tensor, y_val_tensor, model, optimizer, criterion_rec, criterion_clf, params, i, path_model):
    best_v_loss = 1000000
    epochs_no_improve = 0
    max_epochs_stop = 500
...
def IG_attributions(submodel, val_cv, y_val, round_pred, val_samples=7): # OJO: NECESARIO DEFINIR CORRECT_IDX_PREDS EN IGFS_METH
    ...
    attr_df = attr_df.T
    attr_df.columns = y_val.index.to_list()
