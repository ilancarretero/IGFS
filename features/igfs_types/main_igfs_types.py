...
def main_pipeline(args):
    ...
    for seed in seeds:
        ...
        for sel_vars in n_vars:
            ...
            df_pos_neg_mean = igfs_types.pos_neg_attr_good(df_cl_0_mean, df_cl_1_mean, sel_vars)
            df_pos_neg_mod_mean = igfs_types.pos_neg_attr_module(df_cl_0_mean, df_cl_1_mean, sel_vars, occ=False)
            # 2. MEDIAN CASE
            ...
            df_pos_neg_median = igfs_types.pos_neg_attr_good(df_cl_0_median, df_cl_1_median, sel_vars)
            df_pos_neg_mod_median = igfs_types.pos_neg_attr_module(df_cl_0_median, df_cl_1_median, sel_vars, occ=False)
            # 3. OCC_MEAN CASE
            ...
            df_pos_neg_occ_mean = igfs_types.pos_neg_attr_occ_good(df_cl_0_occ_mean, df_cl_1_occ_mean, sel_vars)
            df_pos_neg_mod_occ_mean = igfs_types.pos_neg_attr_module(df_cl_0_occ_mean, df_cl_1_occ_mean, sel_vars, occ=True)
            # 3. OCC_MEDIAN CASE
            ...
            df_pos_neg_occ_median = igfs_types.pos_neg_attr_occ_good(df_cl_0_occ_median, df_cl_1_occ_median, sel_vars)
            df_pos_neg_mod_occ_median = igfs_types.pos_neg_attr_module(df_cl_0_occ_median, df_cl_1_occ_median, sel_vars, occ=True)
            # Save excels
            # 1. MEAN CASE
            ...
            igfs_types.save_data(df_pos_neg_mod_mean, seed, sel_vars, args, 'mean', 'pos_neg_mod')
            # 2. MEDIAN CASE
            ...
            igfs_types.save_data(df_pos_neg_mod_median, seed, sel_vars, args, 'median', 'pos_neg_mod')
            # 3. OCC_MEAN CASE
            ...
            igfs_types.save_data(df_pos_neg_mod_occ_mean, seed, sel_vars, args, 'mode_mean', 'pos_neg_mod')
            # 4. OCC_MEDIAN CASE
            ...
            igfs_types.save_data(df_pos_neg_mod_occ_median, seed, sel_vars, args, 'mode_median', 'pos_neg_mod')
...
def main():
    ...
    parser.add_argument('--igfs_type', default='acc', type=str)
